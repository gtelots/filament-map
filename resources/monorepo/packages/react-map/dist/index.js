...
function FeatureManager() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(Pane, { name: "stateOverlayPane", style: { zIndex: 450 } }),
    /* @__PURE__ */ jsx(Pane, { name: "stateMarkerPane", style: { zIndex: 650 } }),
    features?.map((f, k) => /* @__PURE__ */ jsx(
      GeoJSON,
      {
        data: f,
        ...geojsonOpts
  ...
  const controls = useMemo(() => map(_controls, (opts, name) => {
    ...
    if (name === "layersControl") {
      children = /* @__PURE__ */ jsxs(Fragment$1, { children: [
        ...
        layers?.map(
          ({ selected = false, title = "None", ...layerProps }, k) => /* @__PURE__ */ jsx(LayersControl.Overlay, { name: title, checked: selected, children: /* @__PURE__ */ jsx(
